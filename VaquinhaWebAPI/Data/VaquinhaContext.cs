...
namespace VaquinhaWebAPI.Data 
{
    public class VaquinhaContext : DbContext
    {
        ...
        {            
            ...
            //         new ItemDespesa(-1, "Swift",         350,    2, 1, new DateTime(2023, 3, 25)),
            //         new ItemDespesa(-1, "Viagem",        50,     1, 2, new DateTime(2023, 2, 21)),
            //         new ItemDespesa(-1, "Pão de Açúcar", 58,     2, 1, new DateTime(2023, 4, 25)),
            //         new ItemDespesa(-1, "HortiFrutti",   20,     1, 2, new DateTime(2022, 8, 2)),
            //         new ItemDespesa(-1, "Pão de Açúcar", 250,    2, 2, new DateTime(2022, 1, 18)),
            //     });
       
            // builder.Entity<Pagamento>()
            //     .HasData(new List<Pagamento>() {
            //         new Pagamento(-1, 60, 1, 1),
            //         new Pagamento(-1 ,60, 2, 1),
            //         new Pagamento(-1, 60, 3, 1),
            //         new Pagamento(-1, 70, 4, 1),
            //         new Pagamento(-1, 40, 1, 2),
            //         new Pagamento(-1, 40, 2, 2),
            //         new Pagamento(-1, 40, 3, 2),
            //         new Pagamento(-1, 30, 4, 2),
            //     });
